...
`useEffect` es un Hook que permite sincronizar un componente con el sistema externo. Se ejecuta cada vez que un estado cambia, cuando hay efectos secundarios y cuando se hace limpieza al desmontar el componente. Es un componente difícil de entender al principio, aunque esta es parte de la idea.
